...
[![Deploy to Netlify](https://www.netlify.com/img/deploy/button.svg)](https://app.netlify.com/start/deploy?repository=https://github.com/coverdashllc/liteshow-blog#LITESHOW_PROJECT_SLUG=blog&LITESHOW_API_URL=https://api.liteshow.io)

[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/coverdashllc/liteshow-blog&env=LITESHOW_PROJECT_SLUG,LITESHOW_API_URL&envDescription=Required%20environment%20variables)

**Your project slug:** `blog` (copy and paste when prompted during deployment)
...
- `LITESHOW_PROJECT_SLUG` - Your project slug: `blog`
